...
export const environment = {
  ...
  URL_BACKEND: 'https://app.pulqui.com.ar/api/auth',
 // URL_BACKEND: 'http://localhost/api/auth',
  urlSocket: '34.107.154.137',
  URL_BACKEND_PUBLIC: 'https://app.pulqui.com.ar/api/public',
// URL_BACKEND_PUBLIC: 'http://localhost/api/public',
